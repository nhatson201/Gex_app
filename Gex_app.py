...
# === Tạo trang /health cho UptimeRobot ===
query_params = st.query_params
if "health" in query_params or os.environ.get("PATH", "").startswith("/health"):
    st.write("OK")
    st.stop()
...
if data:
    ...
    st.markdown("---")
    st.caption(f"Nguồn: Binance Options | Tự động cập nhật mỗi 5 phút | Hợp đồng: {data['options_count']}")
